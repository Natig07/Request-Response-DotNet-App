        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReqPriorityId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requests_Categories_ReqCategoryId",
                        column: x => x.ReqCategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Requests_Priorities_ReqPriorityId",
                        column: x => x.ReqPriorityId,
                        principalTable: "Priorities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Requests_Statuses_ReqStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Responses_ResStatus_ResStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_ReqCategoryId",
                table: "Requests",
                column: "ReqCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_ReqPriorityId",
                table: "Requests",
                column: "ReqPriorityId");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_ReqStatusId",
                table: "Requests",
                column: "ReqStatusId");
